...
import { getDomain, getFaviconUrl, getPlatformIcon, isValidUrl } from './link-utils'
export type { PlatformIcon } from './link-utils'
...
// Export utilities from link-utils
export { getDomain, getFaviconUrl, getPlatformIcon, isValidUrl }
